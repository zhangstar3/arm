...
class MoveItDemo:
    def __init__(self):
        ...
        object1_pose.pose.position.x = 0.34
        object1_pose.pose.position.y = -0.25
        ...
        obstacle1_pose.pose.position.y = 0.8
        obstacle1_pose.pose.position.z = 0.3
        ...
        target_pose.pose.position.x = 0.347672
        target_pose.pose.position.y = 0.0535878
        target_pose.pose.position.z = 0.1597
        
        target_pose.pose.orientation.x =-0.0808603 #0.0428 #x
        target_pose.pose.orientation.y =-0.683757  #0.7043
        target_pose.pose.orientation.z =0.719828 #-0.7084
        target_pose.pose.orientation.w =0.0882383 #0.0152
